...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'isn青奇', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个只想躺平的人🛌', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bk.219413.xyz', // 网站地址 例如 www.tangly1024.com
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'isn,青奇,isn青奇', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://beian.miit.gov.cn/', // 备案查询链接，如果用了萌备等备案请在这里填写

  //社交链接，不需要可留空白，例如 CONTACT_WEIBO:'' 
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', //isngr@live.com
  CONTACT_QQ: process.env.NEXT_PUBLIC_CONTACT_QQ || '', //136530240
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个傻逼, Hi，我是一个废物,Hi，只要我没有梦想,我就无忧无虑🎉',
